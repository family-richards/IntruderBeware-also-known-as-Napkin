...
Hopefully it doesn't say this: `Hmm... I'm having trouble with the EEPROM. Try again by running this code again. If that didn't work, put up a issue on GitHub.`
...
But not this: `Hmm... I'm having trouble. Try again by running this code again. If that didn't work, put up a issue on GitHub.`  
...
But not this: `Hmm... try making a issue on GitHub to get some assistance.`  
...
Now it'll say `The settings are found! Give me a second to save them...`
...
Now, open up [code/template/template.ino](code/template/template.ino) and start coding and researching! Imagine... a night camera... warning lights that are internet connected... a camera that can make a timelapse at 100x speed for a year... "Baby Shark" playing when an intruder enters your home... it's endless.  
